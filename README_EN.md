...
Here are example images generated by this system for each format and visual style:
...
- Added a new output aspect ratio: `portrait3_4` (3:4 resolution), ideal for serial educational photo posts on TikTok.

---

## 🌐 Web App (Streamlit Interface)

In addition to the CLI, this project also provides a more user-friendly **Streamlit-based web interface**!
...
Or using Python from a virtual environment:
```bash
...
The web app is designed with:
- Dark mode theme following TikTok's aesthetics.
- Pink buttons (TikTok brand colors).
- Responsive layout.
